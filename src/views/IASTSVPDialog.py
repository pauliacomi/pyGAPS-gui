...
class IASTSVPDialog(QW.QDialog):
    ...
    def setup_UI(self):
        ...
        self.fraction_slider = QHSpinBoxSlider(parent=self)
        ...
        ## Point selection
        self.points_button = QW.QPushButton(self)
    ...
    def translate_UI(self):
        self.setWindowTitle(
            QW.QApplication.translate(
                "IASTSVPDialog", "IAST: selectivity-pressure calculation", None, -1
            )
        )
        self.points_button.setText(
            QW.QApplication.translate("IASTSVPDialog", "Specify pressure", None, -1)
        )
